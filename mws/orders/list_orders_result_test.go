...
func loadExample(name string) string {
	data, _ := ioutil.ReadFile("./examples/" + name + ".xml")
	return string(data)
}
...
func TestListOrdersResult(t *testing.T) {
	Convey("Request result", t, func() {
		...
		Convey("has NextToken", func() {
			So(loiResult.NextToken, ShouldEqual, "2YgYW55IGNhcm5hbCBwbGVhc3VyZS4=")
		})

		Convey("has LastUpdatedBefore", func() {
			So(loiResult.LastUpdatedBefore, ShouldEqual, "2013-09-25T18%3A10%3A21.687Z")
		})

		Convey("has 2 Orders", func() {
			So(loiResult.Orders, ShouldHaveLength, 2)
		})

		Convey("Order 1", func() {
			o1 := loiResult.Orders[0]
		...
		Convey("Order 2", func() {
			...
			Convey("PaymentExecutionDetailItem 1", func() {
				pd1 := o2.PaymentExecutionDetail[0]
			...
			Convey("PaymentExecutionDetailItem 2", func() {
				pd2 := o2.PaymentExecutionDetail[1]
				Convey("has Payment Amount", func() {
			...
			Convey("PaymentExecutionDetailItem 3", func() {
				pd3 := o2.PaymentExecutionDetail[2]
				Convey("has Payment Amount", func() {
